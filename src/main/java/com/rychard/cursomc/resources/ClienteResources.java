...
import com.rychard.cursomc.services.ClienteService;
...
public class ClienteResources {
	...
	public ResponseEntity<Void> insert(@Valid @RequestBody ClienteNewDTO objDTO){//RequestBody transforma json em objeto automaticamente
