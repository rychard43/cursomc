...
import com.rychard.cursomc.domain.Estado;
...
import com.rychard.cursomc.domain.PagamentoComCartao;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		cat4.getProdutos().addAll(Arrays.asList(p3,p7,p2,p1));
		...
		Cliente cli1 = new Cliente(null,"Maria","maria@gmail.com","36378912377", TipoCliente.PESSOASFISICA);
